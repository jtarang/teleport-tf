...
linux_ec2_bootstrap_script_path = "../scripts/remote/install-teleport-debian.sh"                  # Path to EC2 bootstrap script
linux_ec2_ami_ssm_parameter     = "/aws/service/debian/release/bookworm/latest/amd64"             # SSM parameter for AMI ID
...
windows_ec2_bootstrap_script_path = "../scripts/remote/windows-teleport-install.ps1"                                # Path to EC2 bootstrap script
...
rds_db_engine_version          = "17.9"               # Version of PostgreSQL
...
windows_ad_install_bootstrap_script_path = "../scripts/remote/windows-ad-install-and-configure.ps1"
windows_ad_domain_join_bootstrap_script_path = "../scripts/remote/windows-ad-domain-join-server.ps1"
